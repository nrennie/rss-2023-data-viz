...
subtitle: "RSS Annual Conference, Harrogate UK 2023"
editor: source
format: 
  revealjs: 
    theme: RSSstyle.scss
...
Learning from others: the good, the bad, and the ugly.

Visualisations are encountered everywhere.


## Case study 1: Football tickets ##

![](images/Case study-stadium ticket 1.png){fig-alt="Stadium map"}
...
## Case study 1: Football tickets cont'd ##

Select your seat. 

![](images/Case study-stadium ticket 2.png){fig-alt="Stadium map sector"}

- The map is upside down now (pitch at bottom)!

- Seats available are marked red!

## Case study: stadium ticket ##
...
![](images/Case study-stadium ticket 1.png){fig-alt="Stadium map" width=40%}
![](images/Case study-stadium ticket 2.png){fig-alt="Stadium map sector"width=50%}
...
![](images/Case study-Conc time.png){fig-alt="conc-time profile"}

Any issues?

## Case study: impact factor trend ##

![](images/Case study-impact factor trend.png){fig-alt="impact factor trend"}
...
The visualisation enables distilling the information
